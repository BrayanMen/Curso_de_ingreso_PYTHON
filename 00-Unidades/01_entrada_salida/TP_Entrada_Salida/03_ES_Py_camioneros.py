...
3.	Para el departamento de logística:
 ...
 sabiendo que cada uno de ellos puede transportar por viaje 3500kg
    ...
    B.	A partir del ingreso de la cantidad de kilómetros que tiene que recorrer 
estos camiones para llegar al destino de la obra, 
necesitamos que el programa informe cual es el tiempo (en horas) 
que tardará cada uno de los camiones, 
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        camiones_requeridos = toneladas / 3.5
        alert('Cantidad de Camiones', f'Se requieren {math.ceil(camiones_requeridos)} camiones.')

    def btn_tiempo_llegada_on_click(self):
        km = float(self.txt_kilometros.get())
        horas_recorridas = km / 90
        alert('Tiempo Final', f'El tiempo estimado es de {horas_recorridas:.2f} horas.')
